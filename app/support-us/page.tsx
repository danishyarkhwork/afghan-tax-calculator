      ...
      <div className="bg-teal-700 min-h-screen text-white">
        <main className="container mx-auto p-6 max-w-5xl">
          ...
          <p className="mb-6 text-lg leading-relaxed">
            ...
            , we are dedicated to providing a free and accurate tool for
            navigating Afghan tax regulations. To continue offering and
            improving our services, we need your support. Here’s how you can
            help us make a difference:
          </p>

          <h3 className="text-2xl font-semibold mb-4">Why Support Us?</h3>
          <p className="mb-6 text-lg leading-relaxed">
            Your support helps us maintain and enhance our platform, ensuring
            that Afghan taxpayers have access to the best tools for managing
            their tax obligations. With your help, we can continue offering our
            services for free and improve our features to better serve our
            users.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-teal-800 p-6 rounded-lg shadow-lg hover:bg-teal-700 transition duration-300 ease-in-out">
              ...
              <p>
                ...
                AfghanTaxCalculator operational. Donations help us cover costs
                and invest in new features.
              </p>
              <ul className="mt-4">
                <li>
            ...
            <div className="bg-teal-800 p-6 rounded-lg shadow-lg hover:bg-teal-700 transition duration-300 ease-in-out">
              ...
              <p>
                Help us reach more users by sharing AfghanTaxCalculator with
                your network. The more people know about us, the more we can
                help.
              </p>
              <ul className="mt-4">
                <li>
          ...
          <p className="mb-6 text-lg leading-relaxed">
            ...
            Together, we can make a significant impact and help our users
            navigate their tax obligations with ease.
          </p>
