...
const SalaryTax: React.FC = () => {
  ...
  return (
    <FullScreen handle={handle}>
      <div className="flex bg-gray-100 justify-between items-center mb-4">
      ...
      <div
        className="container mx-auto max-w-6xl bg-gray-100 p-0 rounded-lg"
          ...
          <div>
            ...
            <div className="mb-4">
              ...
              <NumericFormat
                thousandSeparator={true}
                value={netSalary}
                onValueChange={(values) => setNetSalary(values.floatValue || 0)}
                className="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-xl"
                placeholder="AFN 0"
                isAllowed={({ floatValue }) =>
                  floatValue === undefined ||
          ...
          <div>
            ...
            <table className="w-full table-auto mb-4">
              ...
              <tbody>
                ...
                <tr>
                  <td className="border px-4 py-2">12,500AFN to 100,000AFN</td>
                  <td className="border px-4 py-2">
