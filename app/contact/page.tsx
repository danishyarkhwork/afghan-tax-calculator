    ...
    <div className="bg-teal-700 min-h-screen text-white">
      <main className="container mx-auto p-4 max-w-6xl">
        ...
        <p className="text-lg mb-2">
          ...
          employees, Rental Tax for landlords, Contractors Tax for self-employed
          individuals, Business Receipts Tax for business owners, and Annual
          Income Tax for an overall yearly tax overview. AfghanTaxCalculator is
          an essential resource for effective tax management in Afghanistan.
        </p>
      </main>
    </div>
  );
