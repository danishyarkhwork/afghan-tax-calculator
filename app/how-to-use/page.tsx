      ...
      <div className="bg-teal-700 min-h-screen text-white">
        <main className="container mx-auto p-6 max-w-6xl">
          ...
          <p className="mb-6 text-lg leading-relaxed">
            ...
            ! Our tool is designed to help you navigate Afghan tax regulations
            with ease. Follow this guide to make the most of our platform:
          </p>
          ...
          <div className="bg-teal-800 p-6 rounded-lg shadow-lg mb-6">
            ...
            <p>
              On the main page, you’ll see different tax categories. Click on
              the one that matches your needs. For example, if you want to
              calculate salary tax, select the "Salary Tax" option.
            </p>
          </div>
          <div className="bg-teal-800 p-6 rounded-lg shadow-lg mb-6">
            <h4 className="text-xl font-semibold mb-3">
          ...
          <div className="bg-teal-800 p-6 rounded-lg shadow-lg mb-6">
            ...
            <p>
              ...
              button. Our tool will process your information and provide you
              with an accurate tax calculation based on current Afghan tax laws.
            </p>
          </div>
          <div className="bg-teal-800 p-6 rounded-lg shadow-lg mb-6">
            <h4 className="text-xl font-semibold mb-3">
            ...
            <p>
              After reviewing your results, you can save them for future
              reference or print them directly from our tool. Use the provided
              options to download or print your tax calculations.
            </p>
          </div>
