      ...
      <div className="bg-teal-700 min-h-screen text-white">
        <main className="container mx-auto p-6 max-w-5xl">
          ...
          <p className="mb-6 text-lg leading-relaxed">
            ...
            to simplify and streamline the process of tax calculation. Our goal
            is to make your tax experience as straightforward as possible by
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-teal-800 p-6 rounded-lg shadow-lg hover:bg-teal-700 transition duration-300 ease-in-out">
              ...
              <p>
                ...
                designed to handle the unique aspects of contractor income.
                Ensure you meet all your tax obligations with ease by accurately
            ...
            <div className="bg-teal-800 p-6 rounded-lg shadow-lg hover:bg-teal-700 transition duration-300 ease-in-out">
              ...
              <p>
                ...
                our comprehensive tool. Whether you’re an individual or a
                business owner, our calculator helps you understand your total
                annual tax liability, ensuring you’re prepared for tax season.
              </p>
            </div>
          </div>
          ...
          <ul className="list-disc list-inside space-y-2 mb-6 text-lg leading-relaxed">
            ...
            <li>
              <strong className="text-teal-300">Accuracy Guaranteed:</strong>{" "}
              Rely on precise and up-to-date calculations based on current
              Afghan tax laws.
            </li>
            <li>
          ...
          <p className="mt-4 text-lg leading-relaxed">
            ...
            your tax calculations and support you in meeting your tax
            obligations.
          </p>
        </main>
      </div>
